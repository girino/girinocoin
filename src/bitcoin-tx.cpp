...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s girinocoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  girinocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded girinocoin transaction") + "\n" +
              "  girinocoin-tx [options] -create [commands]   " + _("Create hex-encoded girinocoin transaction") + "\n" +
              "\n";
