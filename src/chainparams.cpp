...
{
    const char* pszTimestamp = "Militares israelenses embarcam em direção ao Brasil para ajudar nas buscas em Brumadinho";
    const CScript genesisOutputScript = CScript() << ParseHex("043A4F044A7EE8D85E7CF8B1F4C79BE7E562C56061AC50EC0A82C9CF68417A87B772827511DB94EA73F52332D0C5FF1D43A694D7392A0590D6A41109EC8DF9F9AA") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("b25f06d8b33207141b918b85caa0ed50f5ddd851490fe4f821d59bc367298a43");
        ...
        consensus.defaultAssumeValid = uint256S("0xb25f06d8b33207141b918b85caa0ed50f5ddd851490fe4f821d59bc367298a43"); //1441280
        ...
        genesis = CreateGenesisBlock(1548623999, 84038, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xb25f06d8b33207141b918b85caa0ed50f5ddd851490fe4f821d59bc367298a43"));
        assert(genesis.hashMerkleRoot == uint256S("0x902d356264a8b29c2301e462a40a9bdf77e32aedd1d05eb49d9c187b5454e8c0"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        //vSeeds.emplace_back("seed-a.girinocoin.loshan.co.uk");
        //vSeeds.emplace_back("dnsseed.thrasher.io");
        //vSeeds.emplace_back("dnsseed.girinocointools.com");
        //vSeeds.emplace_back("dnsseed.girinocoinpool.org");
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0xbc0c0d9f0c2e4dc6a6958f651a7150aa22b8d8627d6e06f504c0ebfcab474cac"); //612653
        ...
        genesis = CreateGenesisBlock(1486949366, 2904336, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xbc0c0d9f0c2e4dc6a6958f651a7150aa22b8d8627d6e06f504c0ebfcab474cac"));
        assert(genesis.hashMerkleRoot == uint256S("0x902d356264a8b29c2301e462a40a9bdf77e32aedd1d05eb49d9c187b5454e8c0"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        //vSeeds.emplace_back("testnet-seed.girinocointools.com");
        //vSeeds.emplace_back("seed-b.girinocoin.loshan.co.uk");
...
public:
    CRegTestParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x21d2c4cbb023f8d80ed4b7e67a7171fac7f3ad762aa5eb4a897ca6713eb78ea0"));
        assert(genesis.hashMerkleRoot == uint256S("0x902d356264a8b29c2301e462a40a9bdf77e32aedd1d05eb49d9c187b5454e8c0"));
