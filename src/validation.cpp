...
#if defined(NDEBUG)
# error "GirinoCoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "GirinoCoin Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s GIR additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("girinocoin-scriptch");
