...
"""Verify that starting girinocoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start girinocoin with -h for help text")
        ...
        self.log.info("Start girinocoin with -version for version information")
